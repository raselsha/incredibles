...
(function($) {
    ...
    $.carrousel.prototype = {
        ...
        _init: function(options) {
            ...
            this.box = $('.banner_bx');
            this.imgWidth = $('.banner_bx .dg-wrapper img').width();
            ...
            var _self = this;
            for (var i = 0, len = this.button.length; i < len; i++) { // ç‚¹å‡»å°åœ†ç‚¹
        ...
        _layout: function() {
            ...
            this.$currentItm[0].href = 'javascript:void(0);';
      //this.$currentItm[0].getAttribute('link');
        },
...
$(function() {
    var chars_slider = $('.dg-container');
    if (chars_slider.length > 0) {
        var mc = new Hammer.Manager(chars_slider[0], {
            recognizers: [
                [Hammer.Swipe,{ direction: Hammer.DIRECTION_HORIZONTAL }],
            ]
        });
        mc.on("swipe", function(ev) {
            //if($('.dg-container').isOnScreen()) {
                chars_slider.carrousel('next');
            //}
        });
