...
(function($) {
    $.fn.wonderplugincarousel = function(options) {
        ...
        AmazingCarousel.prototype = {
            ...
            calcSameHeight: function() {
                ...
                if (this.options.responsive && this.options.sameheightresponsive) {
                    ...
                    if (screenWidth < this.options.sameheightsmallscreen) itemHeight =
                ...
                if (this.options.versionmark == "AMF" + "ree")
                    for (var i = 0; i < $(".amazingcarousel-image", this.container).length; i++)
                        if (i % 2 == 0) {
                            ...
                            if (item.text().indexOf(this.options.wmtext) < 0 || mklink.length <
                                0) item.append('<a href="' + this.options.watermarklink + '" target="_blank"><div style="display:block!important;visibility:visible!important;z-index:999;position:absolute;bottom:4px;right:4px;padding:3px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;">' + this.options.wmtext + "</div></a>");
                            else {
                                var mkdiv = mklink.parent();
                                if (mklink.css("display") == "none" || mklink.css("visibility") == "hidden" || parseInt(mklink.css("font-size")) < 8 ||
                                    mkdiv.css("display") == "none" || mkdiv.css("visibility") == "hidden" || parseInt(mkdiv.css("font-size")) < 8) {
                                    mklink.attr({
                ...
                if (this.options.responsive)
                    if (this.options.direction ==
                        ...
                        if (this.options.usescreenquery) {
                            ...
                            if (conWidth > 0) {
                                this.visibleItems =
                                    Math.floor(conWidth / this.options.width);
            ...
            createWatermark: function() {
                ...
                else if (this.options.watermarkstyle == "image") wmCode += "<img src='" +
                    this.options.skinsfolder + this.options.watermarkimage + "' style='border:none;' />";
        ...
        this.each(function() {
            ...
            if (this.options.hoveroverlayimage.substring(0, 7).toLowerCase() != "http://" &&
                this.options.hoveroverlayimage.substring(0, 8).toLowerCase() != "https://") this.options.hoveroverlayimage = this.options.skinsfolder + this.options.hoveroverlayimage;
            ...
            var object =
                new AmazingCarousel($(this), this.options, carouselid);
